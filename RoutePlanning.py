...
def clarifyRoute(route, round_array):
    ...
    for arc in route:
        ...
        for round in round_array:
            ...
            if previous_arc.x0 == round[0] and previous_arc.y0 == round[1] and previous_arc.r == round[2] or arc.x0 == \
                    round[0] and arc.y0 == round[1] and arc.r == round[2]:
...
if __name__ == "__main__":
    ...
    rounds = [(85,80,6), (15, 16, 9), (50, 0, 8), (60, 62, 4), (200, 100, 85), (400, 360, 76), (500, 100, 50), (560, 540, 15), (380, 350, 6), (500, 460, 80), (200, 280, 30), (360, 450, 100), (500, 400, 60)]
